...
// Build the full ABsmartly SDK bundle for Zaraz (with WebVitals)
esbuild.buildSync({
...
esbuild.buildSync({
  entryPoints: ['src/zaraz/static/absmartly-sdk-bundle-fast.js'],
  bundle: true,
  minify: true,
  platform: 'browser',
  format: 'iife',
...
esbuild.buildSync({
  entryPoints: ['src/zaraz/static/absmartly-sdk-bundle-lite.js'],
  bundle: true,
  minify: true,
  platform: 'browser',
  format: 'iife',
...
const inlineLiteFilePath = 'src/zaraz/static/sdk-bundle-inline-lite.ts'
